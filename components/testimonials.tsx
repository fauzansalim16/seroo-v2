    ...
    <div className="mx-auto max-w-6xl px-4 sm:px-6">
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.400/.25),transparent)1] md:py-20">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          ...
          <p className="text-lg text-indigo-200/65">Dengarkan langsung pengalaman mitra dan pelanggan yang telah merasakan kualitas Seroo. Kepercayaan mereka adalah alasan kami terus berkembang dan menghadirkan yang terbaik!</p>
        </div>
        ...
        <div>
          ...
          <div className="flex justify-center pb-12 max-md:hidden md:pb-16">
            <div className="relative inline-flex flex-wrap justify-center rounded-[1.25rem] bg-gray-800/40 p-1">
              ...
              >
                <svg className={`fill-current ${category === 1 ? 'text-indigo-500' : 'text-gray-600'}`} xmlns="http://www.w3.org/2000/svg" width="16" height={16}>
              ...
              >
                <svg className={`fill-current ${category === 2 ? 'text-indigo-500' : 'text-gray-600'}`} xmlns="http://www.w3.org/2000/svg" width="16" height={16}>
              ...
              >
                <svg className={`fill-current ${category === 3 ? 'text-indigo-500' : 'text-gray-600'}`} xmlns="http://www.w3.org/2000/svg" width="16" height={16}>
              ...
              >
                <svg className={`fill-current ${category === 4 ? 'text-indigo-500' : 'text-gray-600'}`} xmlns="http://www.w3.org/2000/svg" width="16" height={16}>
              ...
              >
                <svg className={`fill-current ${category === 5 ? 'text-indigo-500' : 'text-gray-600'}`} xmlns="http://www.w3.org/2000/svg" width="16" height={16}>
